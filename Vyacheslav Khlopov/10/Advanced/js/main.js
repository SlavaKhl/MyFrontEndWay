...
let type        = '';
let eqaution    = "";
let historyList = JSON.parse(localStorage.getItem('calculatorHistroy')) || [];

output.innerHTML = localStorage.getItem('Result');
...
let saveToLocalStorage = (eqaution) => {
    ...
    localStorage.setItem('calculatorHistroy', JSON.stringify(historyList));
}
