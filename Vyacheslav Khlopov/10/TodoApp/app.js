...
// Наша задача получить данные из инпута и поместить из в localStorage
// Вывести список дел из localStorage
// И добавить возможно отметить задание как выполненое 
